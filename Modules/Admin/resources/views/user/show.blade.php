                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" id="ratingSubTabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="ratings-given-tab" data-bs-toggle="tab" data-bs-target="#ratings-given" type="button" role="tab">⭐ Ratings Given</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="ratings-received-tab" data-bs-toggle="tab" data-bs-target="#ratings-received" type="button" role="tab">👤 Ratings Received</button>
                                        </li>
                                    </ul>
